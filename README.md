...
```bash
bun add @sudobility/cravings_types
```
...
- **cravings_api** -- Backend API server (Hono + PostgreSQL)
- **cravings_client** -- API client SDK with TanStack Query hooks
- **cravings_lib** -- Business logic library with Zustand stores
- **cravings_app** -- Web application (React + Vite)
- **cravings_app_rn** -- React Native mobile app (Expo)
